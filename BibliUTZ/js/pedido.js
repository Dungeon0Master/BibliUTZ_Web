document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        fetch('../BibliUTZ/cargar_libro.php')
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                ...
                if (tbody && tablaLibros && botonPedido && mensajeDiv) {
                    ...
                    if (data.success && data.results.length > 0) {
                        ...
                        mensajeDiv.innerHTML = '<p>' + (data.error || 'No se encontraron libros en el pedido.') + '</p>';
                    }
                } else {
            ...
            .catch(error => {
                const mensajeDiv = document.getElementById('mensaje');
                if (mensajeDiv) {
                    mensajeDiv.innerHTML = '<p>Ocurrió un error al intentar cargar los libros.</p>';
                }
